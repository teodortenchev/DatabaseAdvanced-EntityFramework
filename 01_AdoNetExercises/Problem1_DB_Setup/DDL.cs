    ...
    class DDL
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                ////Will not work unless Configuration is changed, currently specific db is selected
                ...
                {
                    ExecuteQuery(connection, createStatements[i]);
                }
                ...
                string[] insertStatements =
                {
                    ...
                    ('Cathleen', 11, 2),('Carry ', 50, 10),('Becky', 125, 5),('Mars', 21, 1),('Misho', 5, 10),
                        ('Zoe', 125, 5),('Json', 21, 1)",

                    @"INSERT INTO EvilnessFactors (Name) VALUES ('Super good'),('Good'),('Bad'), ('Evil'),('Super evil')",

                    @"INSERT INTO Villains (Name, EvilnessFactorId) VALUES ('Gru',2),('Victor',1),('Jilly',3),
                        ('Miro',4),('Rosen',5),('Dimityr',1),('Dobromir',2)",

                    @"INSERT INTO MinionsVillains (MinionId, VillainId) VALUES (4,2),(1,1),(5,7),(3,5),(2,6),(11,5),
                        (8,4),(9,7),(7,1),(1,3),(7,3),(5,3),(4,3),(1,2),(2,1),(2,7)"
                };

                for (int i = 0; i < insertStatements.Length; i++)
                {
                    ExecuteQuery(connection, insertStatements[i]);
                }
            }
        }

        private static void ExecuteQuery(SqlConnection connection, string queryText)
        {
            using (SqlCommand command = new SqlCommand(queryText, connection))
            {
                command.ExecuteNonQuery();
